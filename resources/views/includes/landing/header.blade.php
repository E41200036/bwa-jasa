            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                ...
                <nav
                    ...
                    <a href="{{ route('explore.landing') }}"
                        class="block {{ request()->is('explore') || request()->is('explore/*') ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}">Explore</a>
                    ...
                    @auth
                        ...
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button class="block lg:hidden nav-link text-serv-text" type="submit">Logout</button>
                        </form>
                    @endauth
                </nav>
            </div>
