                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Total Harga Service Kamu" type="number" name="price"
                                                id="price" autocomplete="price" value="{{ @old('price') }}" required
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        ...
                                        <div class="col-span-6">
                                            <label for="thumbnail_service"
                                                ...
                                                Feeds</label>
                                            <input placeholder="Thumbnail 1" type="file" name="thumbnail_service[]"
                                                id="thumbnail" autocomplete="thumbnail" value="{{ @old('thumbnail_service[]') }}"
                                            ...
                                            <input placeholder="Thumbnail 2" type="file" name="thumbnail_service[]"
                                                id="thumbnail" autocomplete="thumbnail" value="{{ @old('thumbnail_service[]') }}"
                                                class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            <input placeholder="Thumbnail 3" type="file" name="thumbnail_service[]"
                                                id="thumbnail" autocomplete="thumbnail" value="{{ @old('thumbnail_service[]') }}"
                                                class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Keunggulan 1" type="text" name="advantage_user[]"
                                                id="advantage_user" autocomplete="advantage_user" value="{{ @old('advantage_user[]') }}"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
